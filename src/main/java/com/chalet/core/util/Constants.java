package com.chalet.core.util;

public class Constants {

  // ROOM_TYPE
  public final static String ROOM_TYPE_DELETED_SUCCESSFULLY = "Room type deleted successfully.";
  public final static String ROOM_TYPE_UPDATED_SUCCESSFULLY = "Room type updated successfully.";
